...
//! checkable.
//!
//! Eleven properties, one module each: what the README says about the layering, what the
...
//! XVPE crossing, and whether a rule names only the contract half of a crate that bundles a
//! provider with its contract.
//!

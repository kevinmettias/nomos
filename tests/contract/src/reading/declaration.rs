...
// The three readers that produce a declaration: what a crate exports, the items a module
// holds, and the members inside one. They sit beneath the thing they yield.

...
use crate::masks::{Is_Code, Matching_Brace};
use crate::text::{Collapsed, Line_End};
...
pub(crate) fn Head(text: &str, masks: &crate::masks::Masks, from: usize, end: usize) -> Option<Recognised>
{
...
fn Value_Cut(text: &str, masks: &crate::masks::Masks, range: (usize, usize), kind: &str) -> usize
{
    let (begins, at) = range;
...
fn Assignment(text: &str, masks: &crate::masks::Masks, from: usize, end: usize) -> Option<usize>
{
...
fn Semicolon(text: &str, masks: &crate::masks::Masks, from: usize, end: usize) -> Option<usize>
{
    let bytes = text.as_bytes();
    let mut cursor = from;

...
use crate::exported::{Exported, Inline, Load_Inline, Named, Tail};
use crate::members::{Members_In, Reading};
use crate::module_tree::{Item, Module};
use crate::recogniser::{Head, Recognised};
use crate::text::{Line_End, Next_Line};
...
pub(crate) struct Source<'a>
{
    ...
    pub(crate) masks: &'a crate::masks::Masks,
}

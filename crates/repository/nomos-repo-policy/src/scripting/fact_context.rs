...
/// `crate::naming::FactContext` and `crate::limits::FactContext` carry, for the
...
///
/// `semantic_inputs` is empty, deliberately, the same choice `crate::naming::
/// fact_context::Compute_Fact_Key` and `crate::limits::fact_context::Compute_Fact_Key`

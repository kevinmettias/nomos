...
pub const DESCRIPTORS: &[RuleDescriptor] = &[
    ...
    Descriptor_For(crate::GO_HELPERS_PACKAGE_FIVE_INPUTS, SubjectKind::SourceFacts, &[RequiredFact::SyntaxItems, RequiredFact::LimitsPolicy, RequiredFact::TestMaterialPolicy], crate::Check_Go_Helpers_Package_Five_Inputs),

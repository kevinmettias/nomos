...
pub const DESCRIPTORS: &[RuleDescriptor] = &[
    ...
    Descriptor_For(crate::EVERY_ALLOW_CARRIES_A_JUSTIFICATION, SubjectKind::SourceText, &[], |sources, _reader| return crate::Check_Every_Allow_Carries_A_Justification(sources)),
    ...
    Descriptor_For(crate::SLEEP_BASED_SYNCHRONIZATION, SubjectKind::SourceText, &[], |sources, _reader| return crate::Check_Sleep_Is_Not_Synchronization(sources)),
    ...
    Descriptor_For(crate::A_CREDENTIAL_IS_NOT_HARDCODED_IN_SOURCE, SubjectKind::SourceText, &[], |sources, _reader| return crate::Check_A_Credential_Is_Not_Hardcoded_In_Source(sources)),
    Descriptor_For(crate::A_SECRET_DOES_NOT_TRAVEL_IN_A_URL, SubjectKind::SourceText, &[], |sources, _reader| return crate::Check_A_Secret_Does_Not_Travel_In_A_Url(sources)),
    Descriptor_For(crate::CERTIFICATE_VERIFICATION_IS_NOT_DISABLED, SubjectKind::SourceText, &[], |sources, _reader| return crate::Check_Certificate_Verification_Is_Not_Disabled(sources)),
    ...
    Descriptor_For(crate::ATOMIC_ORDERING_CHOICES_ARE_JUSTIFIED, SubjectKind::SourceText, &[], |sources, _reader| return crate::Check_Atomic_Ordering_Choices_Are_Justified(sources)),
    Descriptor_For(crate::SEQCST_JUSTIFIED_EXPLICITLY, SubjectKind::SourceText, &[], |sources, _reader| return crate::Check_Seqcst_Justified_Explicitly(sources)),
    Descriptor_For(crate::RELAXED_NOT_USED_WHEN_ORDERING_MATTERS, SubjectKind::SourceText, &[], |sources, _reader| return crate::Check_Relaxed_Not_Used_When_Ordering_Matters(sources)),
    Descriptor_For(crate::DATA_NAMES_STAY_LOWER_SNAKE, SubjectKind::SourceFacts, &[RequiredFact::SyntaxItems, RequiredFact::NamingPolicy], crate::Check_Data_Names_Stay_Lower_Snake),
    Descriptor_For(crate::FILE_NAME_MATCHES_DECLARED_TYPE, SubjectKind::SourceFacts, &[RequiredFact::SyntaxItems], crate::Check_File_Name_Matches_Declared_Type),
    ...
    Descriptor_For(crate::PARAMETER_COUNT, SubjectKind::SourceFacts, &[RequiredFact::SyntaxItems, RequiredFact::LimitsPolicy], crate::Check_Parameter_Count),
    Descriptor_For(crate::GO_HELPERS_PACKAGE_FIVE_INPUTS, SubjectKind::SourceFacts, &[RequiredFact::SyntaxItems, RequiredFact::LimitsPolicy], crate::Check_Go_Helpers_Package_Five_Inputs),
    ...
    Descriptor_For(crate::NO_WILDCARD_IMPORTS, SubjectKind::SourceText, &[], |sources, _reader| return crate::Check_No_Wildcard_Imports(sources)),

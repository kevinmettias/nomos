...
mod tests
{
    ...
    /// The identity this capability's one real provider mints for the real, public review
    /// comment its own recorded fixture was captured from -- spelled here as a literal,
    /// because minting is the provider's act and this crate is the agreement it mints into.

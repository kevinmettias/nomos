...
use super::{Assembly, TableRequest, Channels, ExitCode, DocumentSource, TableLine, RowCensus, Report_Store_Error, Vanished, RowScope, PathMatch, Absent_Or};

/// Phase 2's other half: the real rows.
pub(super) fn Table(assembly: &Assembly, request: &TableRequest, channels: &mut Channels<'_>) -> ExitCode
{

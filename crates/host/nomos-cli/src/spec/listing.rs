...
use super::{Assembly, ExitCode, ProjectError, Channels, Catalogue, Report_Project_Error, Profile};

/// A section that selected nothing, as the projection machinery reported it.
pub(super) struct EmptySection<'a>
{
...
pub(super) fn Profiles(channels: &mut Channels<'_>) -> ExitCode
{
...
pub(super) fn Sources(assembly: &Assembly, output: &mut dyn std::io::Write) -> ExitCode
{

//! [`RenderedProjectionResponse`], carried only by [`super::submit::SpecSubmitResponse::
//! Accepted`].
...
/// -- the same fields [`crate::spec::render::SpecRenderResponse::Placed`] carries, kept as
/// its own type here rather than shared with it for the same reason
/// [`crate::spec::committed_preview::CommittedPreviewResponse`] is not shared with

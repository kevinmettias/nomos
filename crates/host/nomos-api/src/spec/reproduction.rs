//! [`ReproductionResponse`], carried only by [`super::commit::SpecCommitResponse`].
...
/// split into three outer variants rather than nested, the same shape `crate::spec::verdict::

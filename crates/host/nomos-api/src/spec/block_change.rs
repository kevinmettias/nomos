//! [`BlockChangeResponse`], shared by [`super::preview::SpecPreviewResponse::Previewed`] and
//! [`super::committed_preview::CommittedPreviewResponse`] -- the same "what changed at the

...
//! way [`super::run`] pairs [`super::run::Handle_Gate_Run`] with [`super::run::GateRunResponse`].
...
///
/// The same walk-and-judge composition [`crate::response::run::Handle_Gate_Run`] already

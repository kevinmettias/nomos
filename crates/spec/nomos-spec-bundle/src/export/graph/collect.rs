//! Reading the graph out of a store: one collector per record kind.
...
use crate::export::{Collect_Rows, Columns, Decode_Json_Column};

pub(crate) fn Collect_Suites(connection: &Connection, records: &mut Vec<Record>) -> Result<(), BundleError>
{
    use crate::Suite;
...
pub(crate) fn Collect_Nodes(connection: &Connection, records: &mut Vec<Record>) -> Result<(), BundleError>
{
    use crate::Node;
...
pub(crate) fn Node_Aliases(connection: &Connection, records: &mut Vec<Record>) -> Result<(), BundleError>
{
...
pub(crate) fn Node_Histories(connection: &Connection, records: &mut Vec<Record>) -> Result<(), BundleError>
{
...
pub(crate) fn Relation_Types(connection: &Connection, records: &mut Vec<Record>) -> Result<(), BundleError>
{
...
pub(crate) fn Collect_Relations(connection: &Connection, records: &mut Vec<Record>) -> Result<(), BundleError>
{
    use crate::Relation;
...
pub(crate) fn Normative_Statements(
...
pub(crate) fn Collect_Lineages(connection: &Connection, records: &mut Vec<Record>) -> Result<(), BundleError>
{
    use crate::Lineage;
...
pub(crate) fn Collect_Omissions(connection: &Connection, records: &mut Vec<Record>) -> Result<(), BundleError>
{
...
pub(crate) fn Record_Front_Matter(
    connection: &Connection,
    records: &mut Vec<Record>,
) -> Result<(), BundleError>
{
...
pub(crate) fn Record_Relations(connection: &Connection, records: &mut Vec<Record>) -> Result<(), BundleError>
{

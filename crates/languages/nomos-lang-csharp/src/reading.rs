...
/// deliberately no `Reading::Empty`, so "the file has no items" is a sentence that can only be
/// said about a file that was successfully read, through [`Facts::Has_No_Declarations`].

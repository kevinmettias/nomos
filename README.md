...
| 40 | `nomos-gate-orchestration` | The seam for the first-class Gate object `ARC-ROADMAP-001` names, starting with `Plan`: composes a real rule registry and reports what it holds, apart from selecting scope, choosing a platform or rendering the answer. |
